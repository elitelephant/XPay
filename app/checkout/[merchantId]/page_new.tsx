          ...
          <>
            ...
            {paymentStatus === "idle" && (
              <>
                ...
                <Card className="mb-4 sm:mb-6 shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-lg sm:text-xl">Manual Payment</CardTitle>
                    <CardDescription className="text-sm sm:text-base">
                      Copy the data and make payment from your wallet manually
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      <label className="text-sm font-medium text-slate-700">Destination address</label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-1 mt-1">
                          <code className="flex-1 p-2 sm:p-3 bg-slate-100 rounded text-xs sm:text-sm font-mono">
                            {paymentMemo}
                          </code>
